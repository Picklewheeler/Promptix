...
const Index: React.FC = () => {
  return (
    <>
      <Header />
      <div className="relative flex flex-col overflow-hidden bg-[#0D0D0D] min-h-screen w-full isolate">
        <img
        ...
        <div className="relative z-10 flex w-full flex-col items-center">
          <div className="flex w-full flex-col items-center text-white max-w-[1440px] px-4 max-md:px-2">
            <main className="w-full flex flex-col items-center header-spacing" id="main-content">
              <HeroSection />
              <ClientLogos />
              <FeaturesSection />
              <SpecialFeatures />
